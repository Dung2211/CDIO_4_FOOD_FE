<template>
    <footer class="text-center text-lg-start text-white" style="background-color: black">
        ...
        <section class="d-flex justify-content-between p-4" style="background-color: #FF8C00">
            <!-- Left -->
            <div class="me-5">
            </div>
            <!-- Left -->
            ...
            <div class="container text-center text-md-start mt-5">
                <div class="row mt-3">
                    <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
                        <h6 class=" fw-bold text-white text-uppercase ">
                            K-FOODS</h6>
                        <hr class=" mt-0 d-inline-block mx-auto"
                            style="width: 60px; background-color: #7c4dff; height: 2px" /><br>
                        <div class="mb-2">
                            <img src="https://i.pinimg.com/736x/f3/81/03/f3810304460608b500a25571bc7d0dd9.jpg" class="img-fluid"
                                style="width: 100px; height: auto;" alt="">
                        </div>
                        <p>
                            Website mua bán đồ ăn ngon Số 1 Việt Nam.
                            Được thực hiện bởi nhóm 10:
                            Trường Khang
                            Ngọc Tiên
                            Duy Ngọc
                        </p>
                    ...
                    <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
                        ...
                        <hr class="mb-4 mt-0 d-inline-block mx-auto"
                            style="width: 60px; background-color: #7c4dff; height: 2px" />
                        <p><i class="fas fa-home mr-3"></i>Duy Tan University</p>
                        <p><i class="fas fa-envelope mr-3"></i> DuyTan@gmail.com</p>
        ...
        <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
            © 2024 Copyright:
            <a class="text-white" href="/">K-FOODS TEAM</a>
        </div>
    </footer>
</template>
<script>
