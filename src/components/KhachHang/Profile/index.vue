<template>
          ...
          <ul class="nav nav-tabs nav-fill mb-4">
            <li class="nav-item">
              <a
                ...
                style="color: #000000"
              >
                <i class="fa-solid fa-user me-2" style="color: #ff9933"></i
                >Thông tin cá nhân
              </a>
            </li>
            <li class="nav-item">
              <a
                ...
                style="color: #000000"
              >
                <i class="fa-solid fa-lock me-2" style="color: #ff9933"></i>Đổi
                mật khẩu
              </a>
            </li>
          </ul>
                  ...
                  <div class="card border-0 shadow-sm">
                    <div class="card-body p-4">
                      ...
                      <div class="mb-4">
                        ...
                        <div class="input-group">
                          <input
                            :type="show_pass_3 ? 'text' : 'password'"
                            class="form-control"
  ...
  <div
    ...
    id="addDiaChiModal"
    tabindex="-1"
    aria-labelledby="addDiaChiModalLabel"
    aria-hidden="true"
  >
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="addDiaChiModalLabel">
            Thêm Mới Địa Chỉ
          </h1>
          <button
            type="button"
        ...
        <div class="modal-body">
          <div class="row">
            ...
            <div class="col-lg-12">
              ...
              >
                <template
                  v-for="(value, index) in list_tinh_thanh"
                  :key="index"
                >
            ...
            <div class="col-lg-12" v-if="dia_chi.id_tinh_thanh">
              ...
              <select
                v-model="dia_chi.id_quan_huyen"
                class="form-select mt-2 mb-3"
              >
                <template
                  v-for="(value, index) in list_quan_huyen"
                  :key="index"
                >
                  <option v-bind:value="value.id">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-2">
            <label class="">Địa chỉ</label>
            <input
              v-model="detail_dia_chi.dia_chi"
              type="text"
              class="form-control"
            />
          </div>
          <div class="mb-2">
            <label class="">Quận Huyện</label>
            <select
              v-model="detail_dia_chi.id_quan_huyen"
    ...
    doiMatKhau() {
      axios
        ...
        .then((res) => {
          if (res.data.status) {
            this.$toast.success(res.data.message);
            // ĐÃ SỬA LỖI Ở ĐÂY: Reset đúng tên biến tiếng Anh
            this.doi_mat_khau = {
              old_password: "",
              password: "",
              re_password: "",
