<template>
  <div
    ...
    style="
      background: url(&quot;/images/bg-shipper-register.jpg&quot;) no-repeat
        center center / cover;
      min-height: 100vh;
    "
  >
    <div class="text-center mb-4">
      <h3 style="color: #ff9900; font-weight: bold">
    ...
    <div class="bg-white rounded shadow p-4 mx-auto" style="max-width: 900px">
      <form class="row g-3">
        ...
        <div class="col-md-6">
          ...
          <input
            v-model="them_shipper.ho_va_ten"
            type="text"
            class="form-control"
          />
        </div>
        ...
        <div class="col-md-6">
          ...
          <input
            v-model="them_shipper.so_dien_thoai"
            type="text"
            class="form-control"
          />
        </div>
        ...
        <div class="col-md-6">
          ...
          <input
            v-model="them_shipper.re_password"
            type="password"
            class="form-control"
          />
        </div>
