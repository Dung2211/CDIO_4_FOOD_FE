<template>
    ...
    <div class="col-md-6 d-none d-md-flex justify-content-center align-items-center" style="background-color: #FFE4C4;">
      <img src="/src/assets/images/login/shipper.jpg" alt="Burger" class="img-fluid" style="height: 850px; width: 100%;" >
    </div>
        ...
        <div class="card-body p-4">
          ...
          <form @submit.prevent="Login">
            ...
            <div class="text-center">
              ...
              <router-link to="/shipper/dang-ky" class="text-decoration-none small ms-2">
                Đăng ký tài khoản
              </router-link>
            </div>
          </form>
