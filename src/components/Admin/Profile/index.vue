            ...
            <div class="card">
              <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                  ...
                  >
                    <h6 class="mb-0">
                      <i class="fa-solid fa-phone text-primary me-2"></i>Số điện
                      thoại
                    </h6>
                  ...
                  >
                    <h6 class="mb-0">
                      <i class="fa-solid fa-calendar text-primary me-2"></i>Ngày
                      tham gia
                    </h6>
                  ...
                  >
                    <h6 class="mb-0">
                      <i class="fa-solid fa-clock text-primary me-2"></i>Lần
                      cuối đăng nhập
                    </h6>
...
export default {
  ...
  methods: {
    // 🚀 THÊM MỚI: Mở cửa sổ chọn file
    chonAnh() {
      document.getElementById("fileAvatarAdmin").click();
    },

    // 🚀 THÊM MỚI: Upload ảnh lên ImgBB
    uploadAnh(event) {
      const file = event.target.files[0];
      if (file) {
        this.$toast.info("Đang tải ảnh lên hệ thống, vui lòng chờ...");

        const formData = new FormData();
        formData.append("image", file);

        // ⚠️ BẠN NHỚ DÁN LẠI MÃ API KEY 32 KÝ TỰ CỦA IMGBB VÀO ĐÂY NHÉ
        ...
        fetch(`https://api.imgbb.com/1/upload?key=${apiKey}`, {
          ...
          .then((result) => {
            if (result.success) {
              ...
              this.$toast.success("Tải ảnh xong! Vui lòng bấm Lưu thay đổi.");
            } else {
